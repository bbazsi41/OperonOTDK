...
with open(input_file, 'r') as i, open(output_file, 'w') as out:
    ...
    i.readline()
    out.write("Operon_ID" + '\t' + "Human uniprot" + '\t' + "Human entrez" + '\t' + "Worm entrez" + '\t' + "GO id" + '\t' + "GO term name" + '\t' + "GO domain" + '\t' + "GO term definition" '\n')
    ...
    for line in i:
        ...
        if line[2] in mapping:
            ...
            if len(line) == 7:
                out.write(line[0] + '\t' + line[1] + '\t' + line[2] + '\t' + mapping[line[2]] + '\t' + line[3] + '\t' + line[4] + '\t' + line[5] + '\t' + line[6] + '\n')
            else:
                out.write(line[0] + '\t' + line[1] + '\t' + line[2] + '\t' + mapping[line[2]] + '\t' + line[3] + '\t' + line[4] + '\t' + line[5] + '\n')
